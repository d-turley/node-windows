...
var Logger = require('./eventlog'),
  ...
  argv = optimist
    ...
    .describe('execoptions', 'The options to be passed to Nodejs when executing the script.')
    .alias('d', 'cwd')
...
var launch = function (logLevel, msg) {
  ...
  var execArgv = [];
  if (argv.execoptions) execArgv = argv.execoptions.split(' ');
  var opts = { env: process.env, execArgv };
  var args = [];
